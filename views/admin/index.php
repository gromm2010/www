...
<div class="ch-container">
            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="<?= Html::a('Главная страница', ['category/index'])?>"><i class="glyphicon glyphicon-home"></i><span> Главная</span></a>
                        </li>
    ...
    <footer class="row">
        <p class="col-md-9 col-sm-9 col-xs-12 copyright">&copy; <a href="http://usman.it" target="_blank">МосСпецТранс</a> 2012 - 2017</p>
